...
# Leitura dos dados com validação adicional
...
if (is.na(codigo) || is.na(salario)) {
  stop("Por favor, insira valores numéricos válidos para o código e salário.")
}
